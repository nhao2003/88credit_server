...
import MailService from '~/services/mail.service';import ZaloPayService from '~/services/zalopay.service';
...
class DependencyInjection {
  ...
  private constructor() {
    ...
    Container.set<ZaloPayService>(ZaloPayService, new ZaloPayService());
